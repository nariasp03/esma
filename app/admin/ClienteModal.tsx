      ...
      >
        ...
        {cargando ? (
          ...
          <>
            ...
            {/* Listas de citas */}
            <Seccion titulo="Próximas citas" citas={proximas} vacia="Sin próximas citas." />
            <Seccion titulo="Pasadas" citas={pasadas} vacia="Sin citas pasadas." />
            <Seccion
              titulo="Canceladas"
              citas={canceladas}
        ...
        <div className="mt-2 space-y-3">
          {citas.map((c) => (
            ...
            >
              ...
              {c.nota && (
                <p className="mt-1 text-xs text-muted">Nota: {c.nota}</p>
              )}
